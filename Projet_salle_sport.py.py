...
def ajouter_exercice(list):
    list = input("Entre vos excercies de la façon suivante : Nom exercice-duree en mintes-calories brulee par minutes (ex : pompe-15-12)\t").split("-")
    print("Exercice ajouté : {}\nTemps de l'exercie en minute : {}\nTes calories brulées par minute : {} ".format(list[0], list[1], list[2] ))
...
def main():
    text = []  # Liste pour stocker les exercices
    while True:
        ...
        if choix == 1:
            ...
            calculer_calories_brulees()  # Appeler la fonction pour calculer les calories brûlées
        elif choix == 4:
